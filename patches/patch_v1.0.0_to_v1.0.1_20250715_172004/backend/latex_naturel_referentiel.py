...
REFERENTIEL_PATH = os.path.join(os.path.dirname(__file__), "Référentiels", "latex_naturel_tencel_luxe3d_tencel_polyester.json")
...
def get_valeur_latex_naturel(largeur, matiere):
    """
    Retourne la valeur du référentiel LATEX NATUREL pour une largeur et une matière donnée.
