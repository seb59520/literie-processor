...
class MatelasApp(QMainWindow):
    ...
    def init_ui(self):
        """Initialise l'interface utilisateur"""
        self.setWindowTitle(f"Application Traitement Devis Matelas - v{get_version()}")
    ...
    def create_left_panel(self):
        ...
        self.semaine_spin.setValue(current_week)
        ...
        self.annee_spin.setValue(current_year)
    ...
    def create_menu_bar(self):
        ...
        # Action Gestionnaire de mises à jour (fusionné avec Administration)
        ...
        # Action Administration (protégée par mot de passe)
        admin_action = QAction('🔐 Administration', self)
        admin_action.setStatusTip('Accès administrateur protégé (gestion versions, patches, logs)')
        ...
        <pre style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; overflow-x: auto;">
{
    ...
    def show_changelog(self):
        ...
        try:
            ...
            dialog = QDialog(self)
            dialog.setWindowTitle("📋 Changelog - Matelas Processor")
            ...
            # Titre
            title_label = QLabel("📋 Historique des Versions - Matelas Processor")
    ...
    def markdown_to_html_changelog(self, markdown_text):
        ...
        html = html.replace("# Changelog - Matelas Processor", 
                           "<h1 style='color: #2c3e50; text-align: center; margin-bottom: 20px;'>📋 Changelog - Matelas Processor</h1>")
