#!/usr/bin/env python3
"""
Script de test pour vérifier l'intégration d'OpenRouter dans l'environnement Docker
"""
...
async def test_openrouter_integration():
    ...
    if not api_key:
        ...
        print("Exemple: export OPENROUTER_API_KEY='sk-or-votre-cle-api-ici'")
        return False
    
    # Vérifier le format de la clé
    if not api_key.startswith('sk-or-'):
        print("❌ Erreur: Format de clé API invalide")
        print("La clé API OpenRouter doit commencer par 'sk-or-'")
        return False
        ...
        async with httpx.AsyncClient() as client:
            ...
            try:
                ...
                if parsed.get('Client'):
                    ...
                    print(f"  - Dimension projet: {parsed['Client'].get('Dimension projet', 'N/A')}")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("🎉 Vous pouvez maintenant utiliser OpenRouter dans l'application.")
    else:
        print("\n❌ Test échoué. Vérifiez la configuration d'OpenRouter.")
        print("📖 Consultez le fichier README_OPENROUTER.md pour plus d'informations.") 