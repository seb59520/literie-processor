#!/usr/bin/env python3
"""
Script pour créer un package distributable avec Python embarqué
"""
...
def download_python_embedded():
    """Télécharge Python embarqué pour Windows"""
...
def create_package_with_python():
    ...
    create_install_scripts_with_python(dist_dir)
    
    # Créer un README principal
    create_main_readme_with_python(dist_dir, version)
...
"""
    ...
    print("✅ Script de lancement Windows créé")

def create_install_scripts_with_python(dist_dir):
    """Crée les scripts d'installation avec Python embarqué"""
...
def create_main_readme_with_python(dist_dir, version):
    """Crée le README principal du package avec Python embarqué"""
