...
class BackendInterface:
    ...
    async def process_pdf_files(self, files: List[str], enrich_llm: bool, llm_provider: str, 
                         ...
                         semaine_sommiers: Optional[int] = None, annee_sommiers: Optional[int] = None) -> Dict:
        """
            ...
            if enrich_llm:
                if llm_provider == "ollama":
                    try:
                        ...
                        import asyncio
                        llm_result = await asyncio.to_thread(lambda: asyncio.run(call_llm(text)))
                    except Exception as e:
...
Réponds uniquement avec le JSON valide, sans explication ni phrase autour."""
    ...
    def _detecter_poignees(self, description: str) -> str:
        ...
        # Détecter d'abord la matière de la housse
    ...
    def _clean_and_parse_json(self, raw_text: str) -> str:
        ...
        try:
            ...
            self.logger.info(f"DEBUG: Parsing direct échoué, tentative nettoyage ASCII")
