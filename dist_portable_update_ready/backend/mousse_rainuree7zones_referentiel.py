...
REFERENTIEL_PATH = get_referentiel_path(r"mousse_rainuree7zones_tencel_luxe3d_tencel_polyester.json")
...
def get_valeur_mousse_rainuree7zones(largeur, matiere):
    """
    Retourne la valeur du référentiel MOUSSE RAINURÉE 7 ZONES pour une largeur et une matière donnée.
